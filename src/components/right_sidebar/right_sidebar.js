 ...
 function Right_side_bar(){
    ...
    return(
        ...
        <div className=" left-984 sticky w-383px">
            <div>
                <div>
                    <ProfileSlice  uname="_deleted__bnjx" aname="Benji" alink={`https://www.instagram.com/_deleted__bnjx`} />
                </div>
            </div>
            <div className="mr-12px -mb-16px">
                <div className="flex flex-row content-stretch items-center shrink-0 box-border self-auto relative justify-start grow-0 py-4px px-16px ">
                    <div className="flex flex-col box-border content-stretch min-w-0 min-h-0 self-auto relative grow items-start ">
                        <span className=" block relative whitespace-pre-line max-w-full  min-w-0">Sugerencias para ti</span>
                    </div>
                    <a className="inline-block relative p-0 border-0 text-center" href="no link for you">
                        <span className="min-w-0 relative block whitespace-pre-line max-w-full text-center cursor-pointer">Ver todo</span>
                    </a>
                </div>
