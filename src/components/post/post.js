                ...
                <div className=" content-stretch flex flex-row  box-border items-center static shrink-0 grow-0 self-auto justify-start">
                    <div className="content-stretch flex flex-col mr-8px box-border shrink-0 grow-0  static items-stretch self-auto justify-start ">
                        <div className=" h-24px w-24px content-stretch justify-center flex flex-col  box-border items-center shrink-0 grow-0  relative self-auto cursor-pointer text-inherit list-none">
                            <svg className="block relative cursor-pointer text-inherit list-none " aria-label="Más opciones" class="_ab6-" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24">
            ...
            <div className="flex flex-col h-full relative">
                <div>
                    <div className="grid grid-cols-2 items-center my-4px">
                        <div className="flex">
                            <span>
                                <div className="justify-center p-8px border-none flex box-border items-center cursor-pointer" role="button">
                                    <div className="flex flex-col justify-center items-center cursor-pointer text-inherit ">
                                        <svg aria-label="Me gusta" className="block relative cursor-pointer text-inherit list-none  " color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height="24" role="img" viewBox="0 0 24 24" width="24">
                            ...
                            <span>
                                <div className=" p-8px flex items-center cursor-pointer border-none text-inherit outline-none" role="button">
                                    <div className="flex flex-col justify-center items-center cursor-pointer ">
                                        <svg aria-label="Comentar" className=" block relative text-inherit cursor-pointer" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24">
                            ...
                            <button className="flex items-center justify-center border-none cursor-pointer p-8px border-0  bg-transparent">
                                <div className="flex justify-center items-center">
                                    <svg aria-label="Compartir publicación" className=" block relative cursor-pointer" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <div className="">
                            <div className="flex box-border justify-center items-center cursor-pointer">
                                <div className="flex flex-col justify-center items-center cursor-pointer">
                                    <svg aria-label="Guardar" className="relative block cursor-pointer" color="rgb(0, 0, 0)" fill="rgb(0, 0, 0)" height="24" role="img" viewBox="0 0 24 24" width="24">
                                        <title>Guardar</title>
                    ...
                    <div className="flex flex-col content-stretch box-border mt-8px static items-stretch  justify-start">
                        <div className="inline-block box-border shrink-0  static self-auto grow-0">
                            <div className=" mr-4px  inline-block">
                                <a className=" inline appearance-none  cursor-pointer text-center relative z-0 " href="https://www.instagram.com/_deleted__bnjx/">_deletd__bnjx</a>
                            </div>
                            <span className="">
                    ...
                    <div className="mt-8px flex flex-col box-border  content-stretch static items-stretch justify-start">
                        <div className=" flex flex-col box-border content-stretch static self-auto shrink-0 grow-0 justify-start items-start">
                            <a className="inline  box-border cursor-pointer" href={comments}>
                        ...
                        <div className="flex flex-row flex-wrap items-center">
                            <form className="border-none flex flex-row grow shrink">
                                <div className="flex flex-row items-center grow shrink">
                                    ...
                                    <textarea className="border-none resize-none flex grow outline-none max-w-full h-18px max-h-80px" placeholder="Añade un comentario..." aria-label="Aañade un comentario..." autoComplete="off" autoCorrect="off" autoCapitalize="off">
